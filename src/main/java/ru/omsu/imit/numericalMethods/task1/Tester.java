...
public class Tester {
    public static void analyze(double[][] matrix, double[] f, double[] expectedAnswers, double[] answers) {
    ...
    private static double get_z_infinity(double[] answers, double[] expectedAnswers) {
    ...
    private static double get_r_infinity(double[][] matrix, double[] f, double[] answers) {
    ...
    public static void main(String[] src) {
        ...
        //g.mygen(a, a_inv, n, alpha, beta, 1, 2, 1, 1); //проостой структуры
        g.mygen(a, a_inv, n, alpha, beta, 0, 0, 2, 1); //жорданова клетка
        analyze(a, f_copy, expectedAnswers, answers);
    }
}
